...
<style type="text/css">
#frame { width:1450px; height:600px; background:url("/thk/save/back2.jpg"); margin:0 auto; background-repeat: no-repeat;}
...
#menu { width:900px; height:100px; margin-right:50px;  float:right; font-size:18px; letter-spacing:3px; padding-top:30px }
