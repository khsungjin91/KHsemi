...
<a href="/thk/qnaWrite.cp" class="button white small under" style="float: right; margin-right: 50px; margin-bottom: 30px ">글쓰기</a>
    ...
    <table width="1100" style="margin-left: 70px">
    	<tr>
    ...
    <c:forEach var="qnalist" items="${qnalist}">
   	<tr>    
      	<td style="height:30px; width:50px "><c:out value="${number}"/>  <c:set var="number" value="${number-1}"/> </td>	
   		...
   		<a href ="/thk/qnaView.cp?num=${qnalist.num}&Pnum=${thisPage}" style="text-decoration: none; color:black">${qnalist.subject}</a></td>
    	<td style="height:30px; width:150px">${qnalist.writer}</td>
    	<td style="height:30px; width:300px">${qnalist.reg_date}</td>
   	</tr>
    </c:forEach>
