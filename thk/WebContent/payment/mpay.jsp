...
<div id="section">
  ...
  <div align=center>월 매출(등록 갯수:${count})</div>
...
<c:if test="${count > 0 }">
  ...
  <a href="/thk/mpay.cp?pageNum=${startPage - 10 }">[이전]</a>
  </c:if>

  <c:forEach var="i" begin="${startPage}" end="${endPage}">
    <a href="/thk/mpay.cp?pageNum=${i}">[${i}]</a>
  </c:forEach>

  <c:if test="${endPage< pageCount }">
    <a href="/thk/mpay.cp?pageNum=${startPage + 10}">[다음]</a>
  </c:if>
</c:if>
<br/>
...
<div align=right>
  ...
  <a href="/thk/mpay.cp" name="mpay" class="button white small under">연 매출</a>&nbsp;&nbsp;&nbsp;&nbsp;
