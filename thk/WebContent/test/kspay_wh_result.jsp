...
%>
	...
	<tr bgcolor="#FFFFFF">
		...
		<td width="380">
			<%=authyn%>(<%= ((authyn != null && authyn.equals("O")) ? "승인성공" : "승인거절") %>) <font color=red> :성공여부값은 영어 대문자 O,X입니다. </font>
		</td>
	</tr>
	<tr bgcolor="#E3E3E3">
	...
	<tr bgcolor="#FFFFFF">
		...
		<td width="380">
			<%=trno%> <font color=red>:KSNET에서 부여한 고유번호입니다. </font>
		</td>
	</tr>
	<tr bgcolor="#E3E3E3">
		<td height="1" colspan="2">
...
<% if (authyn != null && authyn.equals("O")) { %>
	<tr bgcolor="#FFFFFF">
		...
		<td width="380">
			<%=authno%><font color=red>:카드사에서 부여한 번호로 고유한값은 아닙니다. </font>
		</td>
	</tr>
	<tr bgcolor="#E3E3E3">
		<td height="1" colspan="2">
